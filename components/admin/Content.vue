      ...
      <div class="shadow rounded-2xl p-4 bg-white dark:bg-gray-800">
        ...
        <div class="flex flex-col justify-start">
          <p
            ...
            "
          >
            {{ revenue.deposit?.totalDepositThisMonth }}
            <span class="text-sm">$</span>
          </p>
          <div class="flex items-center text-green-500 text-sm">
            <svg
            ...
            <span>{{ revenue.deposit?.growthTotalDeposit }}%</span>
            <span class="text-gray-400">vs last month</span>
          </div>
        </div>
      </div>
      ...
      <div class="shadow rounded-2xl p-4 bg-white dark:bg-gray-800">
        ...
        <div class="flex flex-col justify-start">
          <p
            ...
            "
          >
            {{ revenue.withDraw?.totalWithdrawThisMonth }}
            <span class="text-sm">$</span>
          </p>
          <div class="flex items-center text-green-500 text-sm">
            <svg
            ...
            <span>{{ revenue.withDraw?.growthTotalWithdraw }}%</span>
            <span class="text-gray-400">vs last month</span>
          </div>
        </div>
      </div>
...
export default {
  ...
  async created () {
    await this.revenueStatistics()
  },
  methods: {
    async revenueStatistics () {
      try {
        const dataRevenueStatistics = await this.$api.admin.revenueStatistics()
        this.revenue = dataRevenueStatistics.data
        console.log('111111111111111', this.revenue)
      } catch (error) {
