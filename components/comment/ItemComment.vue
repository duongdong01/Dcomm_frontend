    ...
    <div class="flex flex-col">
      <div class="flex space-x-2 relative">
        ...
        <div class="flex justify-center items-center cursor-pointer ml-1 rounded-full overflow-hidden ">
          <button class="w-7 h-7 rounded-full  hover:bg-gray-700 flex justify-center items-center option-comment" @click.prevent="toggleShowOption" @focusout="showOptionComment(false)">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
            ...
            <!-- delete + report post -->
            <div v-if="isShowOptionComment" class="flex flex-col py-2  absolute w-56 bg-gray-900 border-gray-700 border -right-[230px] top-0 rounded-xl z-[4]">
